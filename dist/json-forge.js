...
var JSONForge = function () {
    function JSONForge() {
        var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        classCallCheck(this, JSONForge);
        var _opts$map = opts.map,
            map = _opts$map === undefined ? {} : _opts$map,
            _opts$prune = opts.prune,
            prune = _opts$prune === undefined ? {} : _opts$prune,
            _opts$compressors = opts.compressors,
            compressors = _opts$compressors === undefined ? {} : _opts$compressors;
